package com.techpassmaster.calculatorappkotlin

import android.os.Bundle
import android.util.Log
import androidx.appcompat.app.AppCompatActivity
import com.techpassmaster.calculatorappkotlin.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        with(binding){
            ...
            //Numbers
            tvOne.setOnClickListener { appendOnExpression("1", false) }
    ...
    private fun appendOnExpression(string: String, clear: Boolean) {
